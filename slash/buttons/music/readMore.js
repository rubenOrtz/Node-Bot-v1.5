...
async function getOnlineBots() {
    ...
    let bot2Emoji = ''
    await axios.get(`http://localhost:${process.env.bot2Port}`).then(res => {
    ...
    let bot3Emoji = ''
    await axios.get(`http://localhost:${process.env.bot3Port}`).then(res => {
    ...
    let bot4Emoji = ''
    await axios.get(`http://localhost:${process.env.bot4Port}`).then(res => {
