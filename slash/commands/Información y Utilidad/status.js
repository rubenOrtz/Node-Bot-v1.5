...
module.exports = class status extends Command {
    ...
    async run(client, interaction, args) {
        ...
        const embed = new MessageEmbed()
            ...
            .addField("<:Discord_Emoji_Black:970394989785931866> " + client.language.STATUS[9], "```" + `${client.emojis.cache.size}` + "```", true)
            .addField("<:Members:970395202219049030> " + client.language.STATUS[10], "```" + `${totalGuilds}` + "```", true)
            .addField("<:botOn:894171595365560340> " + client.language.STATUS[11], "```" + `${moment.duration(client.uptime) .format( `D [${client.language.STATUS[12]}], H [${client.language.STATUS[13]}], m [${client.language.STATUS[14]}], s [${client.language.STATUS[15]}]` )}` + "```", true)
            .addField("<:botOn:894171595365560340> " + client.language.STATUS[16], "```" + `${moment.duration(os.uptime * 1000) .format( `D [${client.language.STATUS[12]}], H [${client.language.STATUS[13]}], m [${client.language.STATUS[14]}], s [${client.language.STATUS[15]}]` )}` + "```", true)
