  ...
  async run(client, interaction, args) {
    ...
    switch (usedBotID) {
      case process.env.bot1id:
        fetch(`http://51.161.86.217:${process.env.bot1Port}/api/v1/247`, {
            method: "POST",
          ...
          .catch(() => {
            ...
            const errorembed2 = new MessageEmbed()
              .setColor(15548997)
              .setFooter("Error en el comando 247 (1)", client.user.displayAvatarURL({
                dynamic: true
              }));
      ...
      case process.env.bot2id:
        fetch(`http://51.161.86.217:${process.env.bot2Port}/api/v1/247`, {
            method: "POST",
            body: JSON.stringify(data),
            headers: {
              "Content-Type": "application/json",
          ...
          .catch(() => {
            ...
            const errorembed2 = new MessageEmbed()
              .setColor(15548997)
              .setFooter("Error en el comando 247 (2)", client.user.displayAvatarURL({
                dynamic: true
              }));
            webhookClient.send(errorembed2)
            interaction.editReply({
      ...
      case process.env.bot3id:
        fetch(`http://51.161.86.217:${process.env.bot3Port}/api/v1/247`, {
            method: "POST",
            body: JSON.stringify(data),
            headers: {
              "Content-Type": "application/json",
          ...
          .catch(() => {
            ...
            const errorembed2 = new MessageEmbed()
              .setColor(15548997)
              .setFooter("Error en el comando 247 (3)", client.user.displayAvatarURL({
                dynamic: true
              }));
            webhookClient.send(errorembed2)
            interaction.editReply({
      ...
      case process.env.bot4id:
        fetch(`http://51.161.86.217:${process.env.bot4Port}/api/v1/247`, {
            method: "POST",
            body: JSON.stringify(data),
            headers: {
              "Content-Type": "application/json",
          ...
          .catch(() => {
            ...
            const errorembed2 = new MessageEmbed()
              .setColor(15548997)
              .setFooter("Error en el comando 247 (4)", client.user.displayAvatarURL({
                dynamic: true
              }));
            webhookClient.send(errorembed2)
            interaction.editReply({
