  ...
  async run(client, interaction, args) {
    ...
    switch (usedBotID) {
      case process.env.bot1id:
        fetch(`http://localhost:${process.env.bot1Port}/api/v1/pause`, {
            method: "POST",
      ...
      case process.env.bot2id:
        fetch(`http://localhost:${process.env.bot2Port}/api/v1/pause`, {
            method: "POST",
            body: JSON.stringify(data),
            headers: {
              "Content-Type": "application/json",
      ...
      case process.env.bot3id:
        fetch(`http://localhost:${process.env.bot3Port}/api/v1/pause`, {
            method: "POST",
            body: JSON.stringify(data),
            headers: {
              "Content-Type": "application/json",
      ...
      case process.env.bot4id:
        fetch(`http://localhost:${process.env.bot4Port}/api/v1/pause`, {
            method: "POST",
            body: JSON.stringify(data),
            headers: {
              "Content-Type": "application/json",
