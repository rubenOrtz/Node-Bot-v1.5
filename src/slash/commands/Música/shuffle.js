        ...
        fetch(`http://${process.env.IP}:${process.env.bot1Port}/api/v1/shuffle`, {
          ...
          .catch(() => {
            ...
            const errorembed2 = new MessageEmbed()
              .setColor(15548997)
              .setFooter("Error en el comando shuffle (1)", client.user.displayAvatarURL({
                dynamic: true
              }));
      ...
      case process.env.bot2id:
        fetch(`http://${process.env.IP}:${process.env.bot2Port}/api/v1/shuffle`, {
          ...
          .catch(() => {
            ...
            const errorembed2 = new MessageEmbed()
              .setColor(15548997)
              .setFooter("Error en el comando shuffle (2)", client.user.displayAvatarURL({
                dynamic: true
              }));
            webhookClient.send(errorembed2)
            interaction.editReply({
      ...
      case process.env.bot3id:
        fetch(`http://${process.env.IP}:${process.env.bot3Port}/api/v1/shuffle`, {
          ...
          .catch(() => {
            ...
            const errorembed2 = new MessageEmbed()
              .setColor(15548997)
              .setFooter("Error en el comando shuffle (3)", client.user.displayAvatarURL({
                dynamic: true
              }));
            webhookClient.send(errorembed2)
            interaction.editReply({
      ...
      case process.env.bot4id:
        fetch(`http://${process.env.IP}:${process.env.bot4Port}/api/v1/shuffle`, {
          ...
          .catch(() => {
            ...
            const errorembed2 = new MessageEmbed()
              .setColor(15548997)
              .setFooter("Error en el comando shuffle (4)", client.user.displayAvatarURL({
                dynamic: true
              }));
            webhookClient.send(errorembed2)
            interaction.editReply({
