...
module.exports = class interactionCreate extends Event {
    ...
    if (interaction.isCommand()) {
        ...
        //CHECK PERMISSION
                if (cmd.permissions.dev === true && !client.devs.includes(interaction.user.id)) return interaction.editReply({content: 'Comando exclusivo para devs', embeds: [], ephermeal: true})
    }
